...
serve(async (req) => {
  ...
  try {
    ...
    const MAINTENANCE_UNTIL = "2026-02-14T12:30:00Z"; // Manutenção ativa
    ...
    const MAINTENANCE_BYPASS_TOKENS: string[] = ["03f78b41e125c61f9443014c12a76b77", "feba2d91f87073deb24012648fce6a70"];
    // ============================
