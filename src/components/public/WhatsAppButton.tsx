  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-1.5">
      ...
      <a
        ...
        className="flex items-center justify-center h-14 w-14 md:h-20 md:w-20 rounded-full shadow-lg hover:scale-110 transition-transform"
        style={{ backgroundColor: "#25D366" }}
      >
        <svg viewBox="0 0 32 32" className="h-8 w-8 md:h-11 md:w-11 fill-white">
