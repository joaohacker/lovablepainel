export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center h-14 w-14 md:h-20 md:w-20 rounded-full shadow-lg hover:scale-110 transition-transform"
