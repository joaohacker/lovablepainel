    ...
    <div className="space-y-8">
      ...
      {stockDepleted && (
        <div className="flex flex-col items-center gap-4 rounded-lg border border-amber-500/30 bg-amber-500/10 px-5 py-6 text-center">
          ...
          <div className="rounded-xl border-2 border-emerald-500/50 bg-emerald-500/10 px-4 py-4 w-full mt-2 flex flex-col items-center gap-2">
            <p className="text-sm font-bold text-emerald-300">✅ Geração por demanda disponível!</p>
            <p className="text-xs text-emerald-300/80">
              Gere créditos pelo painel por demanda enquanto isso.
            </p>
            <a
              href="/"
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-white font-bold px-5 py-2.5 text-xs shadow-lg shadow-emerald-500/30 hover:shadow-emerald-400/40 transition-all duration-300"
            >
